...
- (void)setUpModelsArrays {
	...
	self.model.stationFrequencyData = [NSMutableArray arrayWithObjects:@"Every hour", @"With schedule", @"With schedule", @"With schedule", @"With schedule", @"With schedule", @"With schedule", @"With schedule", @"With schedule", @"With schedule", @"With schedule", @"With schedule", @"With schedule", @"With schedule", @"With schedule", @"With schedule", @"With schedule", @"With schedule", @"With schedule", @"With schedule", nil]; // DEFAULTS
