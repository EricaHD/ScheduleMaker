...
// MAJOR GOALS:
// 1. Add autocomplete from database feature in Schedule view controller (for names AND specific stations)
...
// 4. Revisit DEFAULTs flags and actually implement NSUserDefaults
// 5. Make special stations customizable with +/- buttons
